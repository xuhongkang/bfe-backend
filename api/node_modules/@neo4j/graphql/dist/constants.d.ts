...
export declare const MIN_VERSIONS: readonly [{
    readonly majorMinor: "4.3";
    readonly neo4j: "4.3.2";
}];
export declare const REQUIRED_APOC_FUNCTIONS: readonly ["apoc.util.validatePredicate", "apoc.cypher.runFirstColumnSingle", "apoc.cypher.runFirstColumnMany", "apoc.date.convertFormat"];

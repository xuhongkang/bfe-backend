...
exports.subscriptionDirective = exports.SubscriptionOperations = void 0;
const graphql_1 = require("graphql");
var SubscriptionOperations;
(function (SubscriptionOperations) {
    SubscriptionOperations["CREATE"] = "CREATE";
    SubscriptionOperations["UPDATE"] = "UPDATE";
    SubscriptionOperations["DELETE"] = "DELETE";
    SubscriptionOperations["CREATE_RELATIONSHIP"] = "CREATE_RELATIONSHIP";
    SubscriptionOperations["DELETE_RELATIONSHIP"] = "DELETE_RELATIONSHIP";
})(SubscriptionOperations = exports.SubscriptionOperations || (exports.SubscriptionOperations = {}));
const SUBSCRIPTION_FIELDS = new graphql_1.GraphQLEnumType({
...
exports.subscriptionDirective = new graphql_1.GraphQLDirective({
    ...
    args: {
        operations: {
            ...
            type: new graphql_1.GraphQLNonNull(new graphql_1.GraphQLList(SUBSCRIPTION_FIELDS)),
            defaultValue: [

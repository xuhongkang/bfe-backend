...
const add_measurement_field_1 = require("./add-measurement-field");
...
async function execute({ cypher, params, defaultAccessMode, context, }) {
    ...
    if (measurements) {
        (0, add_measurement_field_1.addMeasurementField)(context, add_measurement_field_1.Measurement.databaseQueryTime, measurements.time);
    }
    return {

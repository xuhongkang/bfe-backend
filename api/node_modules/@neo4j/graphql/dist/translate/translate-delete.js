...
function translateDelete({ context, node }) {
    ...
    const { cypher: authCypher, params: authParams } = (0, create_auth_and_params_1.createAuthAndParams)({
        operations: "DELETE",
        entity: node,
        context,
        allow: {
    ...
    if (authCypher) {
        ...
        allowStr = `WITH ${withVars.join(", ")}\nCALL apoc.util.validate(NOT (${authCypher}), "${constants_1.AUTH_FORBIDDEN_ERROR}", [0])`;
    }
    if (deleteInput) {

...
function translateRead({ node, context, isRootConnectionField, }, varName = "this") {
    ...
    const authPredicates = (0, create_auth_predicates_1.createAuthPredicates)({
        operations: "READ",
        entity: node,
        context,
        allow: {
    ...
    if (authPredicates) {
        (topLevelWhereClause || topLevelMatch).where(cypher_builder_1.default.apoc.util.validatePredicate(cypher_builder_1.default.not(authPredicates), constants_1.AUTH_FORBIDDEN_ERROR));
    }

...
function translateCypherDirectiveProjection({ context, cypherField, field, node, alias, nodeRef, res, cypherFieldAliasMap, }) {
    ...
    if (!cypherField.columnName) {
        ...
        customCypherClause = new cypher_builder_1.default.Unwind([runCypherInApocClause, resultVariable]);
    }
    else {
...
function createCypherDirectiveApocProcedure({ cypherField, expectMultipleValues, context, nodeRef, extraArgs, }) {
    ...
    if (expectMultipleValues) {
        return cypher_builder_1.default.apoc.cypher.runFirstColumnMany(cypherField.statement, apocParamsMap);
    }
    return cypher_builder_1.default.apoc.cypher.runFirstColumnSingle(cypherField.statement, apocParamsMap);
}

...
export declare function createMatchWherePattern(matchPattern: Cypher.Pattern, preComputedWhereFields: Cypher.CompositeClause | undefined, auth: Cypher.Predicate | undefined, wherePredicate: Cypher.Predicate | undefined): Cypher.Clause;
export declare function stringAggregationQuery(matchWherePattern: Cypher.Clause, fieldName: string, fieldRef: Cypher.Variable, targetAlias: Cypher.Node | Cypher.Relationship): Cypher.Clause;

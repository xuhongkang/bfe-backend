...
exports.YieldProjection = exports.Yield = void 0;
...
let Yield = class Yield extends Clause_1.Clause {
    ...
    getCypher(env) {
        ...
        const withStr = (0, compile_cypher_if_exists_1.compileCypherIfExists)(this.withStatement, env, {
            prefix: "\n",
        });
        const returnStr = (0, compile_cypher_if_exists_1.compileCypherIfExists)(this.returnStatement, env, {
            prefix: "\n",
        });
...
exports.YieldProjection = YieldProjection;

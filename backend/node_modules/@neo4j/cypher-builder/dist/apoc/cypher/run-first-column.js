...
class RunFirstColumnFunction extends CypherFunctions_1.CypherFunction {
    ...
    parseVariablesInput(variables = []) {
        if (Array.isArray(variables) || variables instanceof MapExpr_1.MapExpr)
            return variables;
        return new MapExpr_1.MapExpr(variables);
    }
 ...
 */
function runFirstColumnMany(clause, params = []) {
    return new RunFirstColumnFunction(clause, params, true);
}
exports.runFirstColumnMany = runFirstColumnMany;
/**
 * @group Expressions
 * @category Cypher Functions
 */
function runFirstColumnSingle(clause, params = []) {
    return new RunFirstColumnFunction(clause, params, false);
}
exports.runFirstColumnSingle = runFirstColumnSingle;
